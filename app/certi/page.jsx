...
const CertiPage = () => {
  ...
  const [service, setService] = useState(certiServiceOptions[0]);
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded shadow">
      <h2 className="text-2xl font-bold mb-6 text-center">Certification & Other Services Request</h2>
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <select
            ...
            required
          >
            {certiServiceOptions.map(option => (
